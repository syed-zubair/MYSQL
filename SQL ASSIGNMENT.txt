...
select movies.title,directors.director_name from movies join directors on movies.director_id=directors.director_id;                                                                          select movies.title as movie, movies.release_year, directors.director_name from movies join directors on movies.director_id = directors.id;
